...
#include <config.h>
// #include <Watchdog.h>       // TODO: Write watchdog
#include <utilities.h>
...
// Watchdog watchdog;       // TODO: Write watchdog
...
void systemReset(){
        maxonDriver1->reset();
        maxonDriver2->reset();
        // NVIC_SystemReset();            //TODO: Check if necessary
}
 ...
 * filter CAN signals
 */
// void setupHardwareAcceptanceFilter() {         TODO: Write CAN2_wrFilter for CAN acceptance filter
...
void reportEverything() {
        ...
        // heightSensor1.CANReport(&canManager, &heightSensor2);    //TODO: Check if necessary
...
// void getGains(control_gains_t *controlGains){            //TODO: create flash
...
int main() {
        ...
        // watchdog.kick(180.0);          // TODO: Write watchdog

        // flash.loadFromFiles();         //TODO: create flash
        //flash.printValues();
        ...
        Thread processThread(&processHeight, NULL, osPriorityNormal);
        ...
        // setupHardwareAcceptanceFilter();       //TODO: Make CAN Acceptance filter
