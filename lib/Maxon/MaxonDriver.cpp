...
MaxonDriver::MaxonDriver(CanManager *canMaxon, CanManager *canManager, uint16_t nodeID) {
        ...
        // this->flash = new Flash(); // TODO gaat het goed als we meerdere instances hebben van flash?		//TODO: create flash
        this->nodeID = nodeID;
        currentMaxonError = 0;
        this->reachedBoundCount = 0;
        this->heightOn = false;
        this->ready = false;
        this->maxonMotor = new MaxonMotor(this->canMaxonBuffer, this->canMaxon, nodeID);                          //TODO: give back flash
}
...
// void MaxonDriver::updateParameters() {             		//TODO: create flash
