...
MaxonMotor::MaxonMotor(CanBuffer* buffer, CanManager* canManager, uint16_t nodeID)		//TODO: Give back flash
...
//		// Home Offset
	...
	// neutralWings.i = -flash->getNeutralAngle();			//TODO: create flash
